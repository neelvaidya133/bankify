  ...
  const generateTempCard = async () => {
    ...
    try {
      ...
      if (tempCardError) {
        ...
        throw new Error(
          `Failed to create temporary card: ${tempCardError.message}`
        );
      }
                      ...
                      >
                        <div className="flex flex-col">
                          ...
                          {card.card_type === "debit" &&
                            card.bank_accounts?.balance && (
                              <span className="text-sm text-blue-600">
                                Balance:{" "}
                                {formatCurrency(card.bank_accounts.balance)}
                              </span>
                            )}
                        </div>
                      </SelectItem>
              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      copyToClipboard(tempCard.card_number, "Card number")
                    }
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      copyToClipboard(tempCard.expiry_date, "Expiry date")
                    }
                    className="h-8 w-8 shrink-0"
                  >
                    <Copy className="h-4 w-4" />
